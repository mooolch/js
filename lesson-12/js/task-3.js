...
const totalProductsPrice = dataList.reduce((sum, product) => sum + product.price, 0)
console.log(totalProductsPrice)
//========================================================================================================================================================

// 2)Знайти кількість товарів, у яких ціна зменшилась (price < old_price).
const productsWithDisountNum = dataList.reduce(
	(counter, product) => (product.price < product.old_price ? counter + 1 : counter),
	0
)
console.log(productsWithDisountNum)
//========================================================================================================================================================

// 3) Товари, які доступні (sell_status:"available")
// Не совсем понятно что нужно сделать

// Создаем новый массив с такими товарами
// const availableProducts = dataList.filter(product => product.sell_status === 'available')
// console.log(availableProducts)

// Либо получайем id этих товаров
const availableProducts_id = dataList.reduce((arr, product) => {
	if (product.sell_status === 'available') arr.push(product.id)
	return arr
}, [])
console.log(availableProducts_id)
//========================================================================================================================================================
...
const newProductsList = dataList.reduce((arr, product) => {

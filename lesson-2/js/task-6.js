...
let secondProductPrice = parseFloat(prompt('Введiть вартiсть Молока товару (грн)', '0'));
let secondProductQuantity = parseFloat(prompt('Введiть кількість шт. кг', '0'));
let thirdProductPrice = parseFloat(prompt('Введiть вартiсть Морозива товару (грн)', '0'));
